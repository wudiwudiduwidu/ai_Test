...
import AppStaticPage from "@/views/app/AppStaticPage.vue";
import AppPictureView from "@/views/add/AppPictureView.vue";
import userAnswerView from "@/views/admin/userAnswerView.vue";
import AdminUserQuestionPage from "@/views/admin/AdminUserQuestionPage.vue";
...
export const routes: Array<RouteRecordRaw> = [
  ...
  {
    path: "/admin/userQuestion",
    name: "题目信息",
    component: AdminUserQuestionPage,
    meta: {
      access: ACCESS_ENUM.ADMIN,
      hideInMenu: true,
    },
