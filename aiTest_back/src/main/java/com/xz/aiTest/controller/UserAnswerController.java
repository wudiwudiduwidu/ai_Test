...
import com.xz.aiTest.annotation.AuthCheck;
import com.xz.aiTest.common.BaseResponse;
import com.xz.aiTest.common.DeleteRequest;
import com.xz.aiTest.common.ErrorCode;
import com.xz.aiTest.common.ResultUtils;
import com.xz.aiTest.constant.UserConstant;
import com.xz.aiTest.exception.BusinessException;
import com.xz.aiTest.exception.ThrowUtils;
import com.xz.aiTest.mapper.UserAnswerMapper;
import com.xz.aiTest.mapper.UserMapper;
import com.xz.aiTest.model.dto.userAnswer.*;
import com.xz.aiTest.model.entity.App;
import com.xz.aiTest.model.entity.User;
import com.xz.aiTest.model.entity.UserAnswer;
import com.xz.aiTest.model.enums.ReviewStatusEnum;
import com.xz.aiTest.model.vo.UserAnswerVO;
import com.xz.aiTest.scoring.ScoringStrategyExecutor;
import com.xz.aiTest.service.AppService;
import com.xz.aiTest.service.UserAnswerService;
import com.xz.aiTest.service.UserService;
...
public class UserAnswerController {
    ...
    /**
     * 应该是UserAnswerMapper 写道userMapper去了 不想管了
     */
    @Resource
private UserMapper userMapper;
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        Long Id = userAnswerAddRequest.getId();
     ...
     */
        ...
        // 这里返回前10 app信息作为排行榜 上redis 而不是每次查数据库 用定时任务每天更新一次
            return ResultUtils.success(userMapper.getRankForApp());
        }
    ...
    /**
     * @Param 注解是专门给mybatis框架指定查询参数的 里面的变量名 跟 sql变量#{appId}是一样的
     * @param appId
     * @return
     */
        @GetMapping("/answer_result_count")
        public BaseResponse<List<AppAnswerResultCountDTO>> getAppAnswerResultCount(@Param("appId") Long appId) {
            ThrowUtils.throwIf(appId == null || appId <= 0, ErrorCode.PARAMS_ERROR);
            return ResultUtils.success(userAnswerMapper.getAppResultStatic(appId));
        }
