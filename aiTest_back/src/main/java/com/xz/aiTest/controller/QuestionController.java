...
import com.xz.aiTest.model.dto.question.*;
...
import com.xz.aiTest.model.vo.QuestionVO;
import com.xz.aiTest.service.QuestionService;
import com.xz.aiTest.service.UserService;
import com.xz.aiTest.service.impl.AiGenerateImpl;
...
public class QuestionController {
    ...
    // region 增删改查
@Resource
private AiGenerateImpl aiGenerate;
    /**
     * 创建题目
     *
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(@RequestBody AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        // AI 生成
        String result = aiGenerate.GenerateQuestion(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, number);
        // 结果处理 拿到json格式
    ...
    @GetMapping(value = "/ai_generate/sse", produces = "text/event-stream")
    //Get请求不能接收json格式参数的
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest,HttpServletRequest request) {


        return aiGenerate.doSSEGenarate(aiGenerateQuestionRequest,request);
    }
